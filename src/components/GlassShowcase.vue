...
<template>
  <div class="h-full flex flex-col relative">
    ...
    >
      ...
      <motion.div
        drag
        :drag-constraints="containerRef ?? false"
        class="relative z-20"
      >
        <VGlass
          v-bind="glassProps"
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-4">
              <VGlass
                v-bind="glassProps"
                as="button"
                class="px-6 py-2 rounded-lg border border-default backdrop-blur-sm hover:bg-white/20 transition-colors font-medium"
              >
                First Action
              </VGlass>
              <VGlass
                v-bind="glassProps"
                as="button"
                class="px-6 py-2 rounded-lg bg-purple-500/20 border border-default backdrop-blur-sm hover:bg-white/20 transition-colors font-medium"
              >
                Second Action
              </VGlass>
            </div>
      ...
      <div class="space-y-2">
        ...
        <div class="flex flex-wrap gap-4">
          ...
          <VGlass
            v-bind="glassProps"
            as="button"
            class="px-6 py-2 bg-primary/20 rounded-lg border border-default backdrop-blur-sm hover:bg-white/20 transition-colors font-medium"
          >
            Button 2
          </VGlass>
          <VGlass
          ...
          <VGlass
            v-bind="glassProps"
            as="button"
            class="px-6 py-2 rounded-lg bg-black/20 border border-default backdrop-blur-sm hover:bg-white/20 transition-colors font-medium"
          >
            Button 4
          </VGlass>
          <VGlass
            v-bind="glassProps"
            as="button"
            class="px-6 py-2 rounded-lg bg-white/20 border border-default backdrop-blur-sm hover:bg-white/20 transition-colors font-medium"
          >
            Button 5
          </VGlass>
        </div>
      ...
      <div class="space-y-2">
        ...
        <VGlass
          v-bind="glassProps"
          class="p-4 rounded-lg border border-default backdrop-blur-sm"
        >
          <div class="flex items-start gap-3">
            <div
              class="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center shrink-0"
            >
              <span class="text-blue-400 text-xl">ℹ</span>
            </div>
            <div class="flex-1">
      ...
      <div class="space-y-2">
        ...
        <div class="flex items-center justify-center">
          <VGlass
            v-bind="glassProps"
            class="p-8 rounded-xl border border-default backdrop-blur-sm max-w-md w-full"
          >
            <div class="space-y-4">
              <h4 class="text-2xl font-bold">Modal Window</h4>
              <p class="text-muted">
                Example of a modal window with liquid glass effect. This
                demonstrates how the component can be used to create modern UI
                elements.
              </p>
      ...
      <div class="space-y-2">
        ...
        <div class="flex flex-wrap gap-3">
          <VGlass
            v-bind="glassProps"
            class="px-3 py-1 rounded-full border border-default backdrop-blur-sm text-sm font-medium"
          >
            New
          </VGlass>
          <VGlass
